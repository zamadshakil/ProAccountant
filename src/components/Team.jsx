...
export default function Team() {
  return (
    <section className="py-24 bg-neutral-50 relative overflow-hidden" id="team">
      {/* Top half background */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-black text-primary mt-4">
            Meet The Experts
          </h2>
        </motion.div>
        ...
        {/* Card */}
        <motion.div
          className="flex flex-col lg:flex-row items-center gap-12 bg-white rounded-3xl p-8 lg:p-12 shadow-2xl border border-slate-100"
          variants={fadeUp}
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          <div className="lg:w-3/5 space-y-8">
            <h3 className="text-3xl font-bold text-primary">A Partner in Your Prosperity</h3>
            ...
            <p className="text-slate-600 text-base leading-relaxed">
              With over a decade of experience navigating complex financial landscapes, Usama
              leads a team of dedicated professionals who treat your business as their own. We
              go beyond the spreadsheet to understand the heartbeat of your operations.
            </p>
